...
export default function NavBar({children}) {
    return (
        ...
        <div className=" w-72 h-[95vh] rounded-3xl mx-8 my-4  bg-blue-500 fixed flex flex-col justify-between items-center">
            ...
            <div className=" w-48 h-fit flex flex-col gap-3">
                <div className=" h-10 w-14 flex flex-row gap-3 ">
                    <img className="h-10 w-10 rounded-full my-auto " src="dashboard.png"></img>
                ...
                <div className=" h-10 w-14 flex flex-row gap-3 ">
                    <img className="h-10 w-10 rounded-full my-auto object-contain" src="transaction.png"></img>
                    <Link className=" text-center my-auto text-sm mt-2 " href="/dashboard">
                        <span className="text-xl sm:text-base text-center text-white  font-semibold">Transactions</span>
                    </Link>
                </div>
                <div className=" h-10 w-14 flex flex-row gap-3 ">
                    <img className="h-10 w-10 rounded-full my-auto" src="schedule.png"></img>
                ...
                <div className=" h-10 w-14 flex flex-row gap-3 ">
                    <img className="h-10 w-10 rounded-full my-auto" src="users.png"></img>
                    <Link className=" text-center text-sm mt-2 " href="/dashboard">
                        <span className="text-xl sm:text-base text-white font-semibold">Users</span>
                    </Link>
                </div>
                <div className=" h-10 w-14 flex flex-row gap-3 ">
                    <img className="h-10 w-10 rounded-full my-auto" src="settings.png"></img>
                    <Link className=" text-center text-sm mt-2 " href="/dashboard">
